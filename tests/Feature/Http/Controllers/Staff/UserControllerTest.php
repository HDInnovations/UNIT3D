...
test('update rejects promotion to a group requiring 2fa when the user has not confirmed 2fa', function (): void {
    ...
    $this->patch(route('staff.users.update', [$user]), [
