...
final class Torrent extends Model
{
    ...
    public const string SEARCHABLE = <<<'SQL'
            ...
            (
                SELECT COALESCE(JSON_ARRAYAGG(subtitles.language_id), JSON_ARRAY())
                FROM subtitles
                WHERE torrents.id = subtitles.torrent_id
            ) AS json_subtitle_language_ids
    SQL;
    ...
    public function toSearchableArray(): array
    {
        ...
        return [
            ...
            'subtitle_language_ids' => json_decode($torrent->json_subtitle_language_ids ?? '[]'),
