    ...
    Route::middleware([Authenticate::class, CheckIfBanned::class, EnsureEmailIsVerified::class])->group(function (): void {
        ...
        */
        Route::prefix('dashboard')->middleware(CheckForModo::class)->name('staff.')->group(function (): void {
            ...
            // Laravel Log Viewer
            Route::livewire('/laravel-log', 'pages::resources.views.livewire.app.http.livewire.laravel-log-viewer')->middleware(CheckForOwner::class)->name('laravel-log.index');
            ...
            // Torrent Downloads
            Route::livewire('/torrent-downloads', 'pages::resources.views.livewire.app.http.livewire.torrent.download-search')->name('torrent_downloads.index');

            // Torrent Trump Search
            Route::livewire('/torrent-trump-search', 'pages::resources.views.livewire.app.http.livewire.torrent.trump-search')->name('torrent_trumps.index');
