...
return [
    ...
    'no-ban'                         => 'There are no bans in the database for this user!',
    'no-logs'                        => 'There are no invite logs in the database for this user!',
    'no-seedboxes'                   => 'No seedboxes 😔',
    'no-soft-warning'                => 'There are no soft deleted warnings in the database for this user!',
    'no-warning'                     => 'There are no warnings in the database for this user!',
