...
return [
    ...
    'two-step-auth'            => [
        ...
        'security-keys'             => [
            'title'             => 'Security Keys (FIDO2/WebAuthn)',
            'description'       => 'Security keys provide an additional layer of protection for your account. You can use hardware security keys like YubiKey, Google Titan, or other FIDO2-compatible devices.',
            'add-key'           => 'Add security key',
            'no-keys'           => 'You have not registered any security keys yet.',
            'delete-confirm'    => 'Are you sure you want to delete this security key?',
            'key-name'          => 'Key name',
            'key-name-placeholder' => 'e.g., My YubiKey',
            'register-prompt'   => 'Insert your security key and touch it when prompted by your browser.',
            'not-supported'     => 'Your browser does not support security keys.',
        ],
    ],
    'unban'                       => 'Unban user',
    'unfollow'                    => 'Unfollow',
