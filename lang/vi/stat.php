...
return [
    ...
    'request-pending-aproval' => 'Yêu cầu chờ xử lý',
    'select-category'         => 'Vui lòng chọn một danh mục dưới đây',
    'site-stats'              => 'Thống kê trang web',
    'stats'                   => 'Số liệu thống kê',
    'stats-format'            => 'Tất cả số liệu thống kê được hiển thị ở định dạng 100 hàng đầu',
    'top-bankers'             => 'Ngân hàng hàng đầu',
    'top-bountied'            => 'Tiền thưởng hàng đầu',
    'top-completed'           => 'Hoàn thành hàng đầu',
    'top-dead'                => 'Chết hàng đầu',
    'top-downloaded'          => 'Các torrent được tải xuống hàng đầu',
    'top-downloaders'         => 'Trình tải xuống hàng đầu',
