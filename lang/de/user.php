 ...
 */
    ...
    'invites-rules' => [
        'know-and-trust' => 'Lade nur Personen ein, die du kennst und denen du vertraust.',
        'responsible' => 'Du wirst für die von dir eingeladenen Personen verantwortlich gemacht.',
        'yourself' => 'Du darfst dich nicht selber einladen, wir prüfen jeden eingeladenen Nutzer.',
        'trade-or-sell' => 'Handel oder verkaufe keine Invites.',
        'caught' => 'Wenn eine Person, die du eingeladen hast, beim Cheaten, beim Handeln von Accounts oder beim Verkauf / Handel von Invites erwischt wird, wirst du verwarnt.',
    ],
    ...
    'two-step-auth' => [
        ...
        'totp'                      => 'Zeitbasiertes Einmalpasswort (TOTP) Authentifizierung',
        'email'                     => 'E-Mail Authentifizierung',
        'totp-is-enabled'           => 'TOTP-Authentifizierung ist derzeit aktiviert. Um sie zu deaktivieren, klicke bitte auf die Schaltfläche \'Deaktivieren\' unten.',
        'totp-is-disabled'          => 'TOTP-Authentifizierung ist derzeit deaktiviert. Um sie zu aktivieren, klicke bitte auf die Schaltfläche \'Aktivieren\' unten.',
        'password-confirm'          => 'Erfordert Passwortbestätigung',
        'upon-enabling'             => 'Nach der Aktivierung musst du einen gültigen Zwei-Faktor-Authentifizierungscode eingeben.',
        'complete-setup'            => 'Um die TOTP-Authentifizierung abzuschließen, scanne bitte den QR-Code unten mit deiner Authenticator-App (Google Authenticator, Authy, BitWarden, etc.) und gib den TOTP-Code im Formular unten ein.',
        'confirm-code'              => 'TOTP-Code bestätigen',
        'recovery-code'             => 'Zeitbasiertes Einmalpasswort (TOTP) Wiederherstellungscodes',
        'recovery-code-description' => 'Klicke auf die Schaltfläche \'Anzeigen\', um deine Wiederherstellungscodes anzuzeigen. Speichere diese Codes sicher offline, falls du den Zugriff auf dein TOTP-Gerät verlierst. Wenn du glaubst, dass diese Codes kompromittiert wurden, klicke auf \'Zurücksetzen\', um neue Codes zu generieren.',
        'recovery-code-reveal'      => 'Anzeigen',
        'recovery-code-reset'       => 'Zurücksetzen',
        'security-keys'             => [
            'title'                => 'Sicherheitsschlüssel (FIDO2/WebAuthn)',
            'description'          => 'Sicherheitsschlüssel bieten eine zusätzliche Schutzebene für dein Konto. Du kannst Hardware-Sicherheitsschlüssel wie YubiKey, Google Titan oder andere FIDO2-kompatible Geräte verwenden.',
            'add-key'              => 'Sicherheitsschlüssel hinzufügen',
            'no-keys'              => 'Du hast noch keine Sicherheitsschlüssel registriert.',
            'delete-confirm'       => 'Bist du sicher, dass du diesen Sicherheitsschlüssel löschen möchtest?',
            'key-name'             => 'Schlüsselname',
            'key-name-placeholder' => 'z.B. Mein YubiKey',
            'register-prompt'      => 'Stecke deinen Sicherheitsschlüssel ein und berühre ihn, wenn dein Browser dich dazu auffordert.',
            'not-supported'        => 'Dein Browser unterstützt keine Sicherheitsschlüssel.',
        ],
    ],
];
