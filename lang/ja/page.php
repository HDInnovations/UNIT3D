...
return [
    ...
    'aboutus-advantage2'    => '映画やテレビ番組に対する私たちの幅広い情熱に加えて、私たちはまた最も好きではないものの中から最高のセレクションの一つを提供します - ファン！ <em>BIGは</em> 、当社のコンテンツbringers <em>をお願い致します</em> 。',
    ...
    'aboutus-welcome-desc'  => '：titleは<em>コミュニティが構築した</em> Movie / TV / FANRESデータベースです。データのすべての作品は、2017年以来、私たちの素晴らしいコミュニティが追加されました。タイトル強い<em>焦点は、HD</em>コンテンツ、プロアクティブなユーザーベース、素晴らしい/セキュアなコードベースで親切でフレンドリーなスタッフのチームです。',
