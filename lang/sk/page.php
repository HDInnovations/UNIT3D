...
return [
    ...
    'aboutus-header'        => 'Ahoj',
    'aboutus-rules'         => 'Čo od vás potrebujeme',
    'aboutus-rules1'        => 'Byť aktívnym členom komunity! Znamená to, že sa môžete produktívne zapojiť do konverzácií, pridať schválený obsah a pomôcť ostatným používateľom, ak ste schopní.',
    ...
    'blacklist-desc'        => 'Nasledujúce prehliadače a Bittorrent klienti sú na čiernej listine / zakázané od oznamovania: titul',
    'blacklist-webbrowser'  => 'Webový prehliadač',
    'blacklist-emaildomain' => 'Blokovaná doména',
    'email-blacklist-desc'  => 'Nasledujúce e-mailové domény sú blokované z používania. Nemôžete zaregistrovať alebo poslať pozvať na nasledujúce.',
    'email-whitelist-desc'  => 'Nasledujúce e-mailové domény sú iba e-mailové domény povolené byť použitý. Môžete len zaregistrovať alebo poslať pozvať pomocou nasledujúce.',
    'staff-group'           => 'skupina',
    'staff-title'           => 'nadpis',
    'whitelist-emaildomain' => 'Dôveryhodná doména',
];
