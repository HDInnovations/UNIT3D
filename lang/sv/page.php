...
return [
    ...
    'aboutus-header'        => 'Hallå där',
    'aboutus-rules'         => 'Vad vi behöver från dig',
    'aboutus-rules1'        => 'Att vara en aktiv medlem i samhället! Det betyder att du ska gå med i konversationer produktivt, lägga till godkänt innehåll och hjälpa andra användare om du kan.',
    ...
    'blacklist-desc'        => 'Följande webbläsare och Bittorrent-klienter är svartlistade / förbjudna från att anmäla till: titel',
    'blacklist-webbrowser'  => 'Webbläsare',
    'blacklist-emaildomain' => 'Blockerad domän',
    'email-blacklist-desc'  => 'Följande e-postdomäner blockeras från att användas. Du kan inte registrera eller skicka en inbjudan till följande.',
    'email-whitelist-desc'  => 'Följande e-postdomäner är de enda e-postdomänerna som får användas. Du kan bara registrera eller skicka en inbjudan med hjälp av följande.',
    'staff-group'           => 'Grupp',
    'staff-title'           => 'Titel',
    'whitelist-emaildomain' => 'Förtroende Domän',
];
