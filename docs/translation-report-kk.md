# Missing Translation Keys Report for kk
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Браузерлер" |
| `page.blacklist-webbrowser` | "Веб-шолғыш" |
| `validation.attributes.test_name` | "Сынақ атауы" |
| `validation.attributes.test_description` | "Сынақ сипаттамасы" |
| `validation.attributes.test_locale` | "Тілі" |
| `validation.attributes.image` | "Кескін" |
| `validation.attributes.result_text_under_image` | "Кескін астындағы нәтиже мәтіні" |
| `validation.attributes.short_text` | "Қысқа мәтін" |
