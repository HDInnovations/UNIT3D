# Missing Translation Keys Report for sw
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Watazamaji" |
| `page.blacklist-webbrowser` | "Kivinjari cha Wavuti" |
| `validation.attributes.test_name` | "Jina la jaribio" |
| `validation.attributes.test_description` | "Maelezo ya jaribio" |
| `validation.attributes.test_locale` | "Lugha" |
| `validation.attributes.image` | "Picha" |
| `validation.attributes.result_text_under_image` | "Maandishi ya matokeo chini ya picha" |
| `validation.attributes.short_text` | "Maandishi mafupi" |
