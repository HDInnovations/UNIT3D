# Missing Translation Keys Report for ca
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Navegadors" |
| `page.blacklist-webbrowser` | "Navegador web" |
| `validation.attributes.name` | "nom" |
| `validation.attributes.username` | "usuari" |
| `validation.attributes.email` | "correu electrònic" |
| `validation.attributes.first_name` | "nom" |
| `validation.attributes.last_name` | "cognom" |
| `validation.attributes.password` | "contrasenya" |
| `validation.attributes.password_confirmation` | "confirmació de la contrasenya" |
| `validation.attributes.city` | "ciutat" |
| `validation.attributes.country` | "país" |
| `validation.attributes.address` | "adreça" |
| `validation.attributes.phone` | "telèfon" |
| `validation.attributes.mobile` | "mòbil" |
| `validation.attributes.age` | "edat" |
| `validation.attributes.sex` | "sexe" |
| `validation.attributes.gender` | "gènere" |
| `validation.attributes.year` | "any" |
| `validation.attributes.month` | "mes" |
| `validation.attributes.day` | "dia" |
| `validation.attributes.hour` | "hora" |
| `validation.attributes.minute` | "minut" |
| `validation.attributes.second` | "segon" |
| `validation.attributes.title` | "títol" |
| `validation.attributes.body` | "contingut" |
| `validation.attributes.description` | "descripció" |
| `validation.attributes.excerpt` | "extracte" |
| `validation.attributes.date` | "data" |
| `validation.attributes.time` | "hora" |
| `validation.attributes.subject` | "assumpte" |
| `validation.attributes.message` | "missatge" |
