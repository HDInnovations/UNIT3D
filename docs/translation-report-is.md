# Missing Translation Keys Report for is
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Vafrar" |
| `page.blacklist-webbrowser` | "Vefskoðarinn" |
| `validation.attributes.name` | "Nafn" |
| `validation.attributes.username` | "Notendanafn" |
| `validation.attributes.email` | "Netfang" |
| `validation.attributes.first_name` | "Fornafn" |
| `validation.attributes.last_name` | "Eftirnafn" |
| `validation.attributes.password` | "Lykilorð" |
| `validation.attributes.password_confirmation` | "Staðfesting á lykilorði" |
| `validation.attributes.city` | "Borg" |
| `validation.attributes.country` | "Land" |
| `validation.attributes.address` | "Heimilisfang" |
| `validation.attributes.phone` | "Heimasími" |
| `validation.attributes.mobile` | "Farsími" |
| `validation.attributes.age` | "Aldur" |
| `validation.attributes.sex` | "Sex" |
| `validation.attributes.gender` | "Kyn" |
| `validation.attributes.day` | "Dagur" |
| `validation.attributes.month` | "Mánuður" |
| `validation.attributes.year` | "Ár" |
| `validation.attributes.hour` | "Klukkutími" |
| `validation.attributes.minute` | "Mínúta" |
| `validation.attributes.second` | "Sekúnda" |
| `validation.attributes.title` | "Titill" |
| `validation.attributes.content` | "Efni" |
| `validation.attributes.description` | "Lýsing" |
| `validation.attributes.excerpt` | "Excerpt" |
| `validation.attributes.date` | "Dagsetning" |
| `validation.attributes.time` | "Tími" |
| `validation.attributes.available` | "Í boði" |
| `validation.attributes.size` | "Stærð" |
