# Missing Translation Keys Report for eu
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Nabigatzaile" |
| `page.blacklist-webbrowser` | "Web arakatzailea" |
| `validation.attributes.name` | "izena" |
| `validation.attributes.username` | "erabiltzailea" |
| `validation.attributes.email` | "posta elektronikoa" |
| `validation.attributes.first_name` | "izena" |
| `validation.attributes.last_name` | "abizena" |
| `validation.attributes.password` | "pasahitza" |
| `validation.attributes.password_confirmation` | "pasahitzaren berrespena" |
| `validation.attributes.city` | "hiria" |
| `validation.attributes.country` | "herrialdea" |
| `validation.attributes.address` | "helbidea" |
| `validation.attributes.phone` | "telefonoa" |
| `validation.attributes.mobile` | "mugikorra" |
| `validation.attributes.age` | "adina" |
| `validation.attributes.sex` | "sexua" |
| `validation.attributes.gender` | "generoa" |
| `validation.attributes.year` | "urtea" |
| `validation.attributes.month` | "hilabetea" |
| `validation.attributes.day` | "eguna" |
| `validation.attributes.hour` | "ordua" |
| `validation.attributes.minute` | "minutua" |
| `validation.attributes.second` | "segundoa" |
| `validation.attributes.title` | "izenburua" |
| `validation.attributes.content` | "edukia" |
| `validation.attributes.body` | "gorputza" |
| `validation.attributes.description` | "deskribapena" |
| `validation.attributes.excerpt` | "pasartea" |
| `validation.attributes.date` | "data" |
| `validation.attributes.time` | "denbora" |
| `validation.attributes.subject` | "gaia" |
| `validation.attributes.message` | "mezua" |
| `validation.attributes.available` | "erabilgarria" |
| `validation.attributes.size` | "neurria" |
