# Missing Translation Keys Report for fa
...
| `passwords.sent` | "Thanks! If the email address matches an account, a password reset link will be sent." |
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "مرورگرها" |
| `page.blacklist-webbrowser` | "مرورگر اینترنت" |
