# Missing Translation Keys Report for ur
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "براؤزر" |
| `page.blacklist-webbrowser` | "ویب براؤزر" |
| `validation.attributes.test_name` | "ٹیسٹ کا نام" |
| `validation.attributes.test_description` | "ٹیسٹ کی تفصیلات" |
| `validation.attributes.test_locale` | "زبان" |
| `validation.attributes.image` | "تصویر" |
| `validation.attributes.result_text_under_image` | "تصویر کے تحت نتیجے کا متن" |
| `validation.attributes.short_text` | "مختصر متن" |
