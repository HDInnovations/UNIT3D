# Missing Translation Keys Report for bg
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Браузъри" |
| `page.blacklist-webbrowser` | "Уеб браузър" |
| `validation.attributes.name` | "Име" |
| `validation.attributes.username` | "Потребител" |
| `validation.attributes.email` | "E-mail" |
| `validation.attributes.first_name` | "Име" |
| `validation.attributes.last_name` | "Фамилия" |
| `validation.attributes.password` | "Парола" |
| `validation.attributes.city` | "Град" |
| `validation.attributes.country` | "Държава" |
| `validation.attributes.address` | "Адрес" |
| `validation.attributes.phone` | "Телефон" |
| `validation.attributes.mobile` | "GSM" |
| `validation.attributes.age` | "Възраст" |
| `validation.attributes.sex` | "Пол" |
| `validation.attributes.gender` | "Пол" |
| `validation.attributes.day` | "Ден" |
| `validation.attributes.month` | "Месец" |
| `validation.attributes.year` | "Година" |
| `validation.attributes.hour` | "Час" |
| `validation.attributes.minute` | "Минута" |
| `validation.attributes.second` | "Секунда" |
| `validation.attributes.title` | "Заглавие" |
| `validation.attributes.content` | "Съдържание" |
| `validation.attributes.description` | "Описание" |
| `validation.attributes.excerpt` | "Откъс" |
| `validation.attributes.date` | "Дата" |
| `validation.attributes.time` | "Време" |
| `validation.attributes.available` | "Достъпен" |
| `validation.attributes.size` | "Размер" |
| `validation.attributes.recaptcha_response_field` | "Рекапча" |
| `validation.attributes.subject` | "Заглавие" |
| `validation.attributes.message` | "Съобщение" |
