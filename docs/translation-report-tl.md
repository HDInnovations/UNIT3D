# Missing Translation Keys Report for tl
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Mga Browser" |
| `page.blacklist-webbrowser` | "Web Browser" |
| `validation.attributes.test_name` | "Subok na pangalan" |
| `validation.attributes.test_description` | "Subok na paglalarawan" |
| `validation.attributes.test_locale` | "Wika" |
| `validation.attributes.image` | "Imahe" |
| `validation.attributes.result_text_under_image` | "Resultang teksto sa ilalim ng imahe" |
| `validation.attributes.short_text` | "Maikling teksto" |
