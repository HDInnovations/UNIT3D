# Missing Translation Keys Report for el
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Φυλλομετρητές" |
| `page.blacklist-webbrowser` | "Φυλλομετρητής" |
| `playlist.playlist` | "Λίστα" |
| `staff.applicationσ` | "Αιτησεις" |
