# Missing Translation Keys Report for kn
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "ಬ್ರೌಸರ್ಗಳು" |
| `page.blacklist-webbrowser` | "ವೆಬ್ ಬ್ರೌಸರ್" |
| `validation.attributes.name` | "ಹೆಸರು" |
| `validation.attributes.username` | "ಬಳಕೆದಾರ ಹೆಸರು" |
| `validation.attributes.email` | "ಇಮೇಲ್" |
| `validation.attributes.first_name` | "ಮೊದಲ ಹೆಸರು" |
| `validation.attributes.last_name` | "ಕೊನೆಯ ಹೆಸರು" |
| `validation.attributes.password` | "ಪಾಸ್ವರ್ಡ್" |
| `validation.attributes.password_confirmation` | " ಪಾಸ್ವರ್ಡ್ ದೃಢೀಕರಿಸಿ" |
| `validation.attributes.city` | "ನಗರ" |
| `validation.attributes.country` | "ದೇಶ" |
| `validation.attributes.address` | "ವಿಳಾಸ" |
| `validation.attributes.phone` | "ಫೋನ್" |
| `validation.attributes.mobile` | "ಮೊಬೈಲ್" |
| `validation.attributes.age` | "ವಯಸ್ಸು" |
| `validation.attributes.sex` | "ಲಿಂಗ" |
| `validation.attributes.gender` | "ಲಿಂಗ" |
| `validation.attributes.day` | "ದಿನ" |
| `validation.attributes.month` | "ತಿಂಗಳು" |
| `validation.attributes.year` | "ವರ್ಷ" |
| `validation.attributes.hour` | "ಗಂಟೆ" |
| `validation.attributes.minute` | "ನಿಮಿಷ" |
| `validation.attributes.second` | "ಸೆಕೆ೦ಡು" |
| `validation.attributes.title` | "ಶೀರೋನಾಮ" |
| `validation.attributes.content` | "ವಿಷಯ" |
| `validation.attributes.description` | "ವಿವರಣೆ" |
| `validation.attributes.excerpt` | "ಆಯ್ದ ಭಾಗಗಳು" |
| `validation.attributes.date` | "ದಿನಾಂಕ" |
| `validation.attributes.time` | "ಸಮಯ" |
| `validation.attributes.available` | "ಲಭ್ಯವಿದೆ" |
| `validation.attributes.size` | "ಗಾತ್ರ" |
