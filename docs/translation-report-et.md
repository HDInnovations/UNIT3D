# Missing Translation Keys Report for et
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Brauserid" |
| `page.blacklist-webbrowser` | "Veebibrauseris" |
| `validation.attributes.test_name` | "Testi nimi" |
| `validation.attributes.test_description` | "Testi kirjeldus" |
| `validation.attributes.test_locale` | "Keel" |
| `validation.attributes.image` | "Pilt" |
| `validation.attributes.result_text_under_image` | "Tulemuse tekst pildi all" |
| `validation.attributes.short_text` | "Lühitekst" |
