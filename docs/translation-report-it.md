# Missing Translation Keys Report for it
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "browser" |
| `page.blacklist-webbrowser` | "Programma di navigazione in rete" |
| `validation.attributes.name` | "nome" |
| `validation.attributes.username` | "nome utente" |
| `validation.attributes.first_name` | "nome" |
| `validation.attributes.last_name` | "cognome" |
| `validation.attributes.password_confirmation` | "conferma password" |
| `validation.attributes.city` | "città" |
| `validation.attributes.country` | "paese" |
| `validation.attributes.address` | "indirizzo" |
| `validation.attributes.phone` | "telefono" |
| `validation.attributes.mobile` | "cellulare" |
| `validation.attributes.age` | "età" |
| `validation.attributes.sex` | "sesso" |
| `validation.attributes.gender` | "genere" |
| `validation.attributes.day` | "giorno" |
| `validation.attributes.month` | "mese" |
| `validation.attributes.year` | "anno" |
| `validation.attributes.hour` | "ora" |
| `validation.attributes.minute` | "minuto" |
| `validation.attributes.second` | "secondo" |
| `validation.attributes.title` | "titolo" |
| `validation.attributes.content` | "contenuto" |
| `validation.attributes.description` | "descrizione" |
| `validation.attributes.excerpt` | "estratto" |
| `validation.attributes.date` | "data" |
| `validation.attributes.time` | "ora" |
| `validation.attributes.available` | "disponibile" |
| `validation.attributes.size` | "dimensione" |
