# Missing Translation Keys Report for hi
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "ब्राउज़र्स" |
| `page.blacklist-webbrowser` | "वेब ब्राउज़र" |
| `validation.attributes.test_name` | "टेस्ट का नाम" |
| `validation.attributes.test_description` | "टेस्ट का विवरण" |
| `validation.attributes.test_locale` | "भाषा" |
| `validation.attributes.image` | "छवि" |
| `validation.attributes.result_text_under_image` | "छवि के नीचे परिणाम पाठ" |
| `validation.attributes.short_text` | "लघु पाठ" |
