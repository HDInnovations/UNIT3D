# Missing Translation Keys Report for da
...
| Key | Value |
| --- | --- |
| `blocks.latest-poll` | " Seneste Afstemning" |
| `common.by` | "Af" |
| `common.delete-comment` | "Slet kommentar" |
| `common.edit-comment` | "Rediger kommentar" |
| `common.suggested-clients` | "Anbefalede klienter" |
| `page.blacklist-browsers` | "Browsere" |
| `page.blacklist-webbrowser` | "Webbrowser" |
| `staff.commands` | "Kommandoer" |
| `subtitle.search` | "Søg efter torrent" |
| `torrent.c-column` | "F" |
