# Missing Translation Keys Report for cs
...
| Key | Value |
| --- | --- |
| `page.blacklist-browsers` | "Prohlížeče" |
| `page.blacklist-webbrowser` | "Webový prohlížeč" |
| `validation.attributes.password` | "heslo" |
