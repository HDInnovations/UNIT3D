...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Default Poster Visibility
    |--------------------------------------------------------------------------
    | True/1 = Show Posters On Torrents List View
    | False/0 = Hide Posters On Torrents List View
    */
    'default_show_poster' => false,
    ...
    */
    'auth' => [
        'multi-account' => [
            /*
            |--------------------------------------------------------------------------
            | The maximum allowed usernames to fail login before an ip is blocked.
            |--------------------------------------------------------------------------
            | Example : 1
            */
            'max-usernames' => 2,
            /*
            |--------------------------------------------------------------------------
            | The interval (in seconds) allowed to count maximum failed logins before an ip is blocked.
            |--------------------------------------------------------------------------
            | Example : 24 * 3600
            */
            'interval' => 24 * 3600,
            /*
            |--------------------------------------------------------------------------
            | The time an ip is blocked for (in seconds).
            |--------------------------------------------------------------------------
            | Example : 24 * 3600
            */
            'blocked-for' => 4 * 3600,
        ...
        'brute-force' => [
            /*
            |--------------------------------------------------------------------------
            | The maximum allowed failed logins within an interval before an ip is blocked.
            |--------------------------------------------------------------------------
            | Example : 1
            */
            'max-attempts' => 6,
